...
set IDIRS= -Itest -Iinclude -Ic:/DEV/gamedev/base/include -Ic:/DEV/gamedev/maths/include -Ic:/DEV/gamedev/assets/include -Ic:/DEV/gamedev/SAP/include -Ic:/DEV/ENV/msys64/mingw64/include
